...
- [Enums e Pattern Matching](ch06-00-enums.md)
  ...
  - [A Estrutura de Controle de Fluxo `match`](ch06-02-match.md)
...
- [Tratamento de Erros](ch09-00-error-handling.md)
  ...
  - [Usar `panic!` ou Não Usar `panic!`](ch09-03-to-panic-or-not-to-panic.md)
...
- [Um Projeto de E/S: Construindo um Programa de Linha de Comando](ch12-00-an-io-project.md)
  ...
  - [Adicionando Funcionalidade com Desenvolvimento Orientado a Testes](ch12-04-testing-the-librarys-functionality.md)
...
- [Recursos de Linguagens Funcionais: Iteradores e Closures](ch13-00-functional-features.md)
  ...
  - [Desempenho em Loops versus Iteradores](ch13-04-performance.md)
...
- [Fundamentos de Programação Assíncrona: Async, Await, Futures e Streams](ch17-00-async-await.md)
  ...
  - [Um Olhar Mais de Perto para as Traits de Async](ch17-05-traits-for-async.md)
...
- [Recursos de Programação Orientada a Objetos](ch18-00-oop.md)
  ...
  - [Usando Objetos Trait para Abstrair Comportamento Compartilhado](ch18-02-trait-objects.md)
...
- [Padrões e Correspondência](ch19-00-patterns.md)
  - [Todos os lugares em que os padrões podem ser usados](ch19-01-all-the-places-for-patterns.md)
  - [Refutabilidade: Quando um Pattern Pode Falhar ao Casar](ch19-02-refutability.md)
...
- [Projeto Final: Construindo um Servidor Web Multithread](ch21-00-final-project-a-web-server.md)
  ...
  - [Encerramento Elegante e Limpeza](ch21-03-graceful-shutdown-and-cleanup.md)

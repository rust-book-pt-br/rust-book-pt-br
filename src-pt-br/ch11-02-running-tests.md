...
Agora, quando executamos nossos testes, o ` it_works`é executado, mas o ` expensive_test`não:
...
os resultados dos testes ` ignored`e você tem tempo para aguardar os resultados,

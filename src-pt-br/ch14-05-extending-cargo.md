...
quando você executa `cargo --list`. Poder usar `cargo install` para instalar
extensões e depois executá-las como se fossem ferramentas nativas do Cargo é um
benefício muito conveniente do design do Cargo!

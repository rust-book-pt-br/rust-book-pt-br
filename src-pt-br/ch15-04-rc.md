...
posse de um dado valor. Contudo, há casos em que um único valor pode ter múltiplos
...
próxima seção, discutiremos o padrão de mutabilidade interior (_interior

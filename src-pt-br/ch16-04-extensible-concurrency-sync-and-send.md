...
biblioteca padrão; você pode escrever seus próprios recursos de concorrência ou usar os
...
Rustonomicon”][nomicon] tem mais informações sobre essas garantias e sobre como
preservá-las.
...
Como mencionado anteriormente, como muito pouco de como o Rust lida com concorrência faz
parte da linguagem, muitas soluções de concorrência são implementadas como crates.
Eles evoluem mais rapidamente do que a biblioteca padrão, portanto, pesquise
online pelos crates atuais e de ponta para uso em cenários multithread
situações.
